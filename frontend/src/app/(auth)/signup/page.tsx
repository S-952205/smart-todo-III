        ...
        <div className="relative z-10 flex flex-col justify-center items-start w-full px-16 text-white">
          ...
          >
            ...
            <p className="text-xl text-white/80 leading-relaxed font-light">
              Create your space for productivity and peace. Every great achievement starts here.
            </p>
          </motion.div>
        </div>
      </motion.div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-black mb-3 font-poppins">
                Full Name
              </label>
              <input
                id="name"
